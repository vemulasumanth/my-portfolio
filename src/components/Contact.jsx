    ...
    <div name='Contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white' >
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className=''>
                ...
                <p className='py-2 text-gray-400'>Submit the details below to get in touch with me</p>
            </div>
            <div className=''>
          {/* Contact information */}
          ...
          <div className="flex items-center">
            ...
            <div className='flex justify-center items-center mt-0'>
                <form action="https://getform.io/f/ebpdygnb" method='POST' className='flex flex-col w-full md:w-1/2 p-0'>
                    ...
                    <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 mx-auto
